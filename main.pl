...
percursoMenosParagens(Origem, Destino, Caminho/NumParagens):- findall((S/NumParagens),(trajetoEntrePontos(Origem, Destino, S),length(S,NumParagens)),Lista),
                      minimo(Lista,Caminho/NumParagens). 
